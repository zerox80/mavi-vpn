use super::handshake::{connect_and_handshake, HandshakeRequest};
use super::network::{
    self, create_udp_socket, set_adapter_network_config, AdapterNetworkConfig, SessionRouteGuard,
};
use super::pump::{pump_quic_to_tun, pump_tun_to_quic, PtbContext};
use super::reauth;
use super::reconnect::SessionEnd;
use super::runtime_state::VpnRuntimeState;
...
pub(super) fn extract_endpoint_ip(remote_ip: std::net::IpAddr) -> String {
    match remote_ip {
...
pub(super) fn determine_session_result(still_running: bool) -> SessionEnd {
    if still_running {
