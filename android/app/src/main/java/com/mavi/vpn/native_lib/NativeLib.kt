...
object NativeLib {
    ...
    external fun init(service: MaviVpnService, token: String, endpoint: String, certPin: String, censorshipResistant: Boolean, http3Framing: Boolean, echConfig: String): Long
